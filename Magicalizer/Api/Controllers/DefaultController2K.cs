...
/// <summary>
/// Default controller for managing models with a composite primary key consisting of two properties.
/// </summary>
...
public class DefaultController<TKey1, TKey2, TModel, TDto, TFilter> : ControllerBase<TModel, TDto, TFilter>
  where TModel : class, IModel, new()
  where TDto : class, IDto, new()
  where TFilter : class, IFilter, new()
{
  protected readonly IService<TKey1, TKey2, TModel, TFilter> service;

  /// <summary>
  /// Initializes a new instance of the <see cref="DefaultController{TKey1, TKey2, TModel, TDto, TFilter}"/> class.
  /// </summary>
  ...
  public DefaultController(IAuthorizationService authorizationService, IService<TKey1, TKey2, TModel, TFilter> service)
  ...
  public virtual async Task<ActionResult<TDto>> GetAsync(TKey1 id1, TKey2 id2, string? fields = null)
  {
    ...
    TDto? dto = this.ModelToDto(await this.service.GetByIdAsync(id1, id2, fields.SplitByComma().Select(f => new Inclusion<TModel>(f)).ToArray()));
  ...
  public virtual async Task<IActionResult> PatchAsync(TKey1 id1, TKey2 id2, [FromBody] JsonPatchDocument<TDto> dtoPatch)
  {
    ...
    TDto? dto = this.ModelToDto(await this.service.GetByIdAsync(id1, id2));
  ...
  public virtual async Task<IActionResult> DeleteAsync(TKey1 id1, TKey2 id2)
  {
    ...
    if (await this.service.DeleteAsync(id1, id2))
      return this.NoContent();
